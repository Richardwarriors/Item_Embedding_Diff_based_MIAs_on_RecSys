...
train_member_recommendation = pd.read_csv("../data/processed_ml-1m/processed_Lml1m/target_recommendations.csv")
...
train_nonmember_recommendation = pd.read_csv("../data/processed_ml-1m/processed_Lml1m/target_nonmember_recommendation.csv")
...
with open(dir_path + "/test_ML.txt", 'w') as f:
