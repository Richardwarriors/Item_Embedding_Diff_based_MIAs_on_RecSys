...
train_member = pd.read_csv("../data/processed_AMB/shadow_member.csv")
member_interacted_dict = train_member.groupby('userId')['itemId'].apply(list).to_dict()
#print(member_interacted_dict[1])
train_member_recommendation = pd.read_csv("../data/processed_AMB/processed_NAMB/shadow_recommendations.csv")
...
train_nonmember = pd.read_csv("../data/processed_AMB/shadow_nonmember")
nonmember_interacted_dict = train_nonmember.groupby('userId')['itemId'].apply(list).to_dict()
#print(nonmember_interacted_dict[3230])

train_nonmember_recommendation = pd.read_csv("../data/processed_AMB/processed_NAMB/shadow_nonmember_recommendation.csv")
...
with open(dir_path + "/train_BN.txt", 'w') as f:
