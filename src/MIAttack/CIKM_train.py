...
train_member_recommendation = pd.read_csv("../data/processed_ml-1m/processed_Nml1m/shadow_recommendations.csv")
...
train_nonmember_recommendation = pd.read_csv("../data/processed_ml-1m/processed_Nml1m/shadow_nonmember_recommendation.csv")
...
with open(dir_path + "/train_MN.txt", 'w') as f:
