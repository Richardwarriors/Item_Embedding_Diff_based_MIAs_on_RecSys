...
LiRA_data = {
    "MNMN": [0.392, 0.525, 0.671, 0.919,1],
    "MLML": [0.378, 0.496, 0.678, 0.921,1],
    "DNDN": [0.572, 0.589, 0.921, 0.987,1],
    "DLDL": [0.568, 0.692, 0.981, 0.992,1],
    "BNBN": [0.331, 0.357, 0.989, 0.993,1],
    "BLBL": [0.363, 0.653, 0.991, 0.992,1]
}
...
def plot_log_roc_curves(path, files):
    ...
    for char in files:
        ...
        full_label = label_mapping.get(char, char)
        label = f"{full_label} item-diff"
        # 获取 FPR 和 TPR
